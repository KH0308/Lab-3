...
public class ReadDailyState5
{
	public static void main(String[] args)
	{
		//Read from File 1st station in Alor Gajah state
		// 1. Declare output file 
		String sourceFile = "Station1AG.txt";
		...
		try {
			...
			System.out.print("\nAverage Rainfall for Melaka Pindah in "
		...
		// 1. Declare output file 
		String sourceFile2 = "Station2AG.txt";
		...
		try {
			...
			System.out.print("\nAverage Rainfall for Ladang Lendu in "
		...
		// 1. Declare output file 
		String sourceFile3 = "Station1JSN.txt";
		System.out.println("\nReading data from " + sourceFile + "\n");
		...
		try {
			...
			System.out.print("\nAverage Rainfall for Hospital Jasin in "
		...
		// 1. Declare output file 
		String sourceFile4 = "Station2JSN.txt";
		System.out.println("\nReading data from " + sourceFile + "\n");
		...
		try {
			...
			System.out.print("\nAverage Rainfall for Ldg. Bkt. Asahan in "
		...
		// 1. Declare output file 
		String sourceFile5 = "Station1MT.txt";
		System.out.println("\nReading data from " + sourceFile + "\n");
		...
		try {
			...
			System.out.print("\nAverage Rainfall for Klebang Besar in "
		...
		// 1. Declare output file 
		String sourceFile6 = "Station2MT.txt";
		System.out.println("\nReading data from " + sourceFile + "\n");
		...
		try {
			...
			System.out.print("\nAverage Rainfall for Cheng (Taman Merdeka) in "
